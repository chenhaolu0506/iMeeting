...
class MeetingGraph extends Component {
    ...
    makeDraw = ( ) => {
        ...
        let searchMeetInfo = this.props.searchMeetInfo.filter((item, i) => {
            return this.props.roomListShow[i]
        })

        // let startTime = +new Date();
        let categories = this.props.roomList.filter((item, i) => this.props.roomListShow[i]).map(item => item.name);
        let types = [
