        ...
        const columns = [
            {
                ...
                render: (item) => {
                    return (
                        <div>
                            <Tooltip title="审核通过">
                                <Button onClick={(ev) => { this.pass(ev, item.id) }}><CheckOutlined /></Button>
                            </Tooltip>
                            <Tooltip title="审核不通过">
                                <Button onClick={(ev) => { this.reject(ev, item.id) }}><CloseOutlined style={{ color: "red" }} /></Button>
                            </Tooltip>
                            <Tooltip title="删除">
                ...
                <Row>
                    <Col span={18} offset={3}>
                        <Card
                            ...
                            <Modal
                                className="clearfix"
                                open={this.state.fileModalVisible}
